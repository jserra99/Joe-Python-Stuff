...
def load_leaderboard(file_name, leader_names, leader_scores):
  ...
  for line in leaderboard_file:
    ...
    '''Super lazy, I know but pltw gave me faulty indexing code leading to indexing errors. 
    tldr: it cant tell if its the end of the file. 
    If this was a big important project I would have have an algorithm see the file/index max length 
    and not go past that but this is a leaderboard...'''
    try:
        while (line[index] != "\n"):
